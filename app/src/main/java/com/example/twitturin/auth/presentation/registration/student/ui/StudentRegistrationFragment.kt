...
import com.example.twitturin.auth.presentation.registration.student.screens.StudentRegistrationScreen
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        composeView.setContent {
            StudentRegistrationScreen(
                ...
                onRegistered = { findNavController().navigate(R.id.action_studentRegistrationFragment_to_signInFragment) }
            )
        }
    }
}
